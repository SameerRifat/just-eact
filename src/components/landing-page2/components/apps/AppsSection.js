            ...
            <div className={styles.apps_container}>
                {!mdUp && (
                    <h2 className={styles.apps_heading}>
                        {t("Find your flavour even faster")}
                    </h2>
                )}
                <div className={styles.apps_sub_container}>
                    ...
                    <div className={styles.apps_right}>
                        ...
                        <p>
                            {t("Download the Just Eat app for faster ordering and more personalised recommendations.")}
                        </p>
                        <div className={styles.app_links}>
                            <Link href='#' className={styles.app_link}>
                                <Image src='/landing-page/apple-download.svg' alt={t("apple download")} width={135} height={40} />
                            </Link>
                            <Link href='#' className={styles.app_link}>
                                <Image src='/landing-page/play-store-download.svg' alt={t('play-store download')} width={135} height={40} />
                            </Link>
                        </div>
                    </div>
                </div>
