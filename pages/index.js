...
import LandingPage from "../src/components/landing-page2/LandingPage";
...
export const getServerSideProps = async (context) => {
  ...
  const configRes = await fetch(`https://partner.dialeat.co.uk/api/v1/config`, {
    method: "GET",
    headers: {
  ...
  const landingPageRes = await fetch(
    "https://partner.dialeat.co.uk/api/v1/react-landing-page",
    {
      method: "GET",
      headers: {
        "X-software-id": 33571750,
